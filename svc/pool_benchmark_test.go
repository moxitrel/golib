...
func BenchmarkPoolPerf_Pool_0(b *testing.B) {
	o := NewPool(1, 1, _POOL_WORKER_DELAY, time.Minute, 0, func(interface{}) {})
	call := o.Call
...
func BenchmarkPoolPerf_Pool_1(b *testing.B) {
	o := NewPool(1, 1, _POOL_WORKER_DELAY, time.Minute, 1, func(interface{}) {})
	call := o.Call
...
func BenchmarkPoolPerf_Pool_8(b *testing.B) {
	o := NewPool(1, 1, _POOL_WORKER_DELAY, time.Minute, math.MaxUint8, func(interface{}) {})
	call := o.Call
...
func BenchmarkPoolPerf_Pool_16(b *testing.B) {
	o := NewPool(1, 1, _POOL_WORKER_DELAY, time.Minute, math.MaxUint16, func(interface{}) {})
	call := o.Call
